...
South African Casino (Khasino) is a digital gaming platform for the traditional South African card game. This repository contains both a React/Vite prototype for the card game setup screen and comprehensive software specification documentation.

### Current Prototype

The prototype demonstrates:
- 40-card deck with Ace through 10 in four suits
- 2, 3, or 4 player deal setup
- Random first dealer
- Human seat at the bottom, CPU seats around the table
- Face-up table card for 3-player deals
- Player state scaffolding for hand, capture pile, and builds
