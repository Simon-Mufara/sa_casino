...
13. **[Real-Time System Design](./08-realtime-system.md)**
...
14. **[Mobile App Design](./13-mobile-app.md)**
...
15. **[Backend Design](./14-backend-design.md)**
...
16. **[DevOps & Infrastructure](./15-devops.md)**
    - CI/CD Pipeline
...
17. **[Security Design](./11-security.md)**
...
18. **[Quality Assurance](./16-quality-assurance.md)**
...
19. **[UI/UX Design](./12-ui-ux-design.md)**
...
20. **[Implementation Plan](./20-implementation-plan.md)**
...
### For Engineers
Start with:
1. [Game Design Document](./03-game-design-document.md) - Understand the game
2. [System Architecture](./05-system-architecture.md) - Understand the tech stack
3. [Database Design](./06-database-design.md) - Understand data models
4. [API Specification](./07-api-specification.md) - Understand interfaces

### For Product Managers
Start with:
1. [Executive Summary](./01-executive-summary.md) - Big picture
2. [Product Requirements](./02-product-requirements.md) - Feature details
3. [Product Roadmap](./17-product-roadmap.md) - Timeline
4. [UI/UX Design](./12-ui-ux-design.md) - User experience

### For Investors
Start with:
1. [Executive Summary](./01-executive-summary.md) - Overview
2. [Investor Pitch Deck](./19-investor-pitch.md) - Presentation
3. [Business Model](./18-business-model.md) - Financials
4. [Implementation Plan](./20-implementation-plan.md) - Execution

### For Designers
Start with:
1. [Game Design Document](./03-game-design-document.md) - Game mechanics
2. [UI/UX Design](./12-ui-ux-design.md) - Design specs
3. [Product Requirements](./02-product-requirements.md) - User needs
...
- [Game Design Document](./03-game-design-document.md) - Formalized software rules
